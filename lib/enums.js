...
export const paymentMethodsEnums = ["Cash", "Card", "Crypto", "Other"];

export const currenctyEnums = ["USD", "EUR", "CHF", "AUD", "CAD", "GBP", "JPY"];
...
export const printerStatusEnums = ["Online", "Offline", "Out of paper", "Error"];
...
export const notificationEnums = ["Warning", "Emergency", "Info", "Message", "Promotion", "Birthday", "Event"];

export const salesInstanceStatusEnums = ["Occupied", "Reserved", "Bill", "Closed"];

export const subscriptionEnums = ["Free", "Basic", "Premium", "Enterprise"];

export const idEnums = ["National ID", "Passport", "Driving License"];
...
export const orderStatusEnums = ["Sent", "Done", "Dont Make", "Hold", "Delivered"];
// once it has been started, it can't be cancel
// "Dont Make" means it has been done before it been requested, it cannot be cancel

export const billingStatusEnums = ["Open", "Paid", "Void", "Cancel", "Invitation"];
...
export const budgetImpactEnums = ["Very Low", "Low", "Medium", "High", "Very High"];

export const inventoryScheduleEnums = ["daily", "weekly", "monthly"];
...
export const othersSubcategoryEnums = [
  "Cleaning",
  "Office",
  "Furniture",
  "Disposable",
...
export const employeePayFrequencyEnums = ["Hourly", "Daily", "Weekly", "Monthly"];