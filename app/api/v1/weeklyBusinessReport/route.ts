...
// @desc    Get all weekly reports, optional filter by businessId and/or startWeek/endWeek (ISO date)
// @route   GET /api/v1/weeklyBusinessReport?businessId=...&startWeek=YYYY-MM-DD&endWeek=YYYY-MM-DD
// @access  Private
export const GET = async (req: Request) => {
  try {
    ...
    if (startWeek && endWeek) {
      ...
      query.weekReference = { $gte: start, $lte: weekEnd(end) };
    }
    ...
    return handleApiError(
      "Get weekly business reports failed!",
