...
/**
 * Actual usage = opening balance + purchases in period - closing balance.
 * Opening = closed inventory with latest updatedAt < startDate.
 * Closing = closed inventory with latest updatedAt <= endDate.
 */
