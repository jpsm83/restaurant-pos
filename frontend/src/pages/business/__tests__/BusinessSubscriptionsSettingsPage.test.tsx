...
import BusinessSubscriptionsSettingsPage from "../BusinessSubscriptionsSettingsPage";
...
describe("BusinessSubscriptionsSettingsPage", () => {
  it("renders subscriptions settings section", async () => {
    await renderWithI18n(
      <MemoryRouter initialEntries={["/business/1/settings/subscriptions"]}>
        <Routes>
          <Route
            path="/business/:businessId/settings/subscriptions"
